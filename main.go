...
import (
	//"Cl-signature/core"
	//"Cl-signature/core/BN254"
	"fmt"
	"github.com/core/go/core"
	"github.com/core/go/core/BN254"
)
...
func main() {
	...
	LHS:=BN254.Ate(a,Z);  LHS=BN254.Fexp(LHS)
	RHS:=BN254.Ate(A,G1); RHS=BN254.Fexp(RHS)
	...
	LHS=BN254.Ate(a,Y);  LHS=BN254.Fexp(LHS)
	RHS=BN254.Ate(b,G1); RHS=BN254.Fexp(RHS)
	...
	RHS=BN254.Ate(c,G1);  RHS=BN254.Fexp(RHS)
	RHS1:=BN254.Ate(a,X); RHS1=BN254.Fexp(RHS1)
	RHS2:=BN254.Ate(b,X); RHS2=BN254.Fexp(RHS2);
	RHS3:=BN254.Ate(B,X); RHS3=BN254.Fexp(RHS3);
